...
public class EditServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {           
           String name = request.getParameter("e_uname");
           String email = request.getParameter("e_uemail");
           String ugender = request.getParameter("eugender");
           String about = request.getParameter("e_about").trim();
           String password = request.getParameter("upass");
           String image = request.getParameter("eimage");
           int id =Integer.parseInt(request.getParameter("eid"));
           //Create User Object
            UserTable user = new UserTable(id, name, email, password, ugender, about,image);
           //Craete User Dao Object
